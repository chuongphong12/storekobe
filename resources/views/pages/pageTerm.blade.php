                                        ...
                                        <div class="single-post__header-meta">
                                            ...
                                            <div class="col-lg-2 col-md-6 pl--15 pl-sm--15">
                                                <div class="single-post__meta">
                                                    <div class="social">
                                                        <a href="https://www.facebook.com/kobevietnam.com.vn" class="social__link" style="padding-right: 10px">
                                                          <img src="/assets/img/icons/ic-facebook.svg" width="10">
                                                        </a>
                                                        <a href="#" class="social__link" style="padding-right: 10px">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <?php 
                                $posts=DB::table('pages')->where('type','Term')->take(3)->get();
                                ?>
