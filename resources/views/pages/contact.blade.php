    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="page-title">Contact with uss</h1>
                <ul class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-5 mb-sm--30">
                        ...
                        <div class="contact-info mb--20">
                            ...
                            <p><b>Hotline: </b><a href="tel:0988 09 65 29">0988 09 65 29</a> - <a
                                    href="tel:0985 09 65 29">0985 09 65 29</a></p>
                        </div>
                        <div class="social">
                        ...
                        <form action="{{route('contact')}}" method="POST" class="form">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6" {{ $errors->has('cusname') ? 'has-error' : '' }}>
                                    ...
                                    <input type="text" class="form__input mb--20" id="inputHoten" name="cusname"
                                        placeholder="Your namw*" value="{{ old('cusname') }}">
                                ...
                                <div class="form-group col-md-6" {{ $errors->has('email') ? 'has-error' : '' }}>
                                    ...
                                    <input type="email" class="form__input mb--20" name="email" id="inputEmail"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="subject" class="form__input mb--20" id="inputTieude"
                                        placeholder="Subject*">
                            ...
                            <textarea class="form__input form__input--textarea mb--20" placeholder="Message..."
                                id="con_message" name="content"></textarea>
