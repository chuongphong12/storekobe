      ...
      <div class="row">
        <div class="col-md-6 ml-auto mr-auto">
          <div class="register-box">
            <h4 class="heading__tertiary mb--30 text-center">Reset Your Password</h4>
            <form class="form form--login" method="POST" action="{{ route('password.update') }}">
              ...
              <div class="form__group mb--20 form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                ...
                <input id="password_confirmation" type="password"
                  class="form__input @error('password_confirmation') is-invalid @enderror" name="password_confirmation"
