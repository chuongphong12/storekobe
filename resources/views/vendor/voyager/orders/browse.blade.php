              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="no-sort no-click" id="bread-actions">
                    ...
                    <a href="{{route('voyager.order_detail',$data->id)}}" title="View"
                      class="btn btn-sm btn-warning pull-right view" style="margin-right: 5px;">
                      <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">Detail</span>
                    </a>
                    @endif
                  </td>
                </tr>
